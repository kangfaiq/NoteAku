...
import net.fortinity.noteaku.fragment.AddNoteFragment;
import net.fortinity.noteaku.fragment.HomeFragment;
import net.fortinity.noteaku.fragment.ProfileFragment;
...
public class MainActivity extends AppCompatActivity {
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                switch (tab.getPosition()) {
                    ...
                    case 1:
                        setCustomView(1, 0, 2);
                        setTextAndImageWithAnimation("ADD NOTE", R.drawable.outline_post_add);
                        //change to the fragment which you want to display
                        handleFragment(new AddNoteFragment());
                        break;
    ...
    private void setCustomView(int selectedtab, int non1, int non2) {
